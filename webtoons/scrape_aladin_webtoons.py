...
def scrape_aladin_bestsellers():
    """
    알라딘 만화 > 인터넷연재만화 베스트셀러 페이지에서 상위 10개 도서 정보를 스크래핑합니다.
    """
    url = "https://www.aladin.co.kr/shop/common/wbest.aspx?BestType=Bestseller&BranchType=1&CID=7443"
    ...
    try:
        ...
        # webtoons_data 폴더에 저장
        data_dir = "../webtoons_data"
        os.makedirs(data_dir, exist_ok=True)
        filename = os.path.join(data_dir, "aladin_webtoons.json")
