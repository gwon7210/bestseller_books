...
def scrape_yes24_bestsellers():
    ...
    url = "https://www.yes24.com/product/category/monthweekbestseller?pageNumber=1&pageSize=24&categoryNumber=001001011&type=week&saleYear=2025"
    ...
    try:
        ...
        book_items = soup.select("div.itemUnit")[:10]
    ...
    filename = os.path.join(data_dir, "yes24_hobbyHealth.json")
