...
def scrape_yes24_bestsellers():
    ...
    url = "https://www.yes24.com/product/category/monthweekbestseller?pageNumber=1&pageSize=24&categoryNumber=001001025&type=week&saleYear=2025"
    ...
    filename = os.path.join(data_dir, "yes24_economics.json")
