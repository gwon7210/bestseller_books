...
def scrape_aladin_bestsellers():
    """
    알라딘 예술 대중문화 > 컬러링북 베스트셀러 페이지에서 상위 10개 도서 정보를 스크래핑합니다.
    """
    url = "https://www.aladin.co.kr/shop/common/wbest.aspx?BestType=Bestseller&BranchType=1&CID=114988"
    ...
    try:
        ...
        filename = os.path.join(data_dir, "aladin_coloringBooks.json")
