...
def scrape_aladin_bestsellers():
    """
    알라딘 건강/취미 베스트셀러 페이지에서 상위 10개 도서 정보를 스크래핑합니다.
    """
    url = "https://www.aladin.co.kr/shop/common/wbest.aspx?BestType=Bestseller&BranchType=1&CID=55889"
    ...
    try:
        ...
        filename = os.path.join(data_dir, "aladin_essay.json")
