...
# 3. 책 리스트 API 호출
url = f"https://www.ypbooks.co.kr/back_shop/base_shop/api/v1/best-seller/bestCd/1/10?year={year}&month={month}&week={max_week}&searchDiv=W&outOfStock=y&categoryIdKey=&categoryBestCd=A004"
...
filename = os.path.join(data_dir, "ypbooks_essay.json")
